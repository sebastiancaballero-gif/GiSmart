// Ejemplo del esquema de empalme de una mufa (cables, buffers, hilos y
// bandejas de fusión). Por ahora es un ejemplo fijo compartido por todas las
// mufas: todavía no hay un backend real que devuelva el esquema propio de
// cada una. Cuando exista, este archivo se reemplaza por un fetch al backend.
export const MUFA_SCHEMA_EXAMPLE = {
  mufa_id: 231235,
  tipo: "CM 48H",
  estado: "Operativa",
  capacidad_band: 4,
